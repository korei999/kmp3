...
struct FlatArena : IArena
{
    ...
    FlatArena(isize reserveSize, isize commitSize = getPageSize()) noexcept(false); /* AllocException */
...
struct ArenaPushGuard
{
    ...
    ArenaPushGuard(FlatArena* p) noexcept;
    ~ArenaPushGuard() noexcept;
};

inline
ArenaPushGuard::ArenaPushGuard(FlatArena* p) noexcept
...
inline
FlatArena::FlatArena(isize reserveSize, isize commitSize)
{
...
inline void
FlatArena::commit(void* p, isize size)
{
#ifdef ADT_FLAT_ARENA_MMAP
...
inline void
FlatArena::decommit(void* p, isize size)
{
#ifdef ADT_FLAT_ARENA_MMAP
